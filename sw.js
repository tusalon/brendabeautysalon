...
const urlsToCache = [
  ...
  '/brendabeautysalon/vendor/react.production.min.js',
  '/brendabeautysalon/vendor/react-dom.production.min.js',
  '/brendabeautysalon/vendor/babel.min.js',
  '/brendabeautysalon/vendor/bcrypt.min.js',
  '/brendabeautysalon/vendor/tailwind-browser.js',
  '/brendabeautysalon/vendor/lucide/lucide.css',
  '/brendabeautysalon/vendor/lucide/lucide.woff2',
  '/brendabeautysalon/utils/push-config.js',
  '/brendabeautysalon/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/brendabeautysalon/icons/icon-192x192.png',
    badge: '/brendabeautysalon/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/brendabeautysalon/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/brendabeautysalon/admin.html';
  event.waitUntil(
